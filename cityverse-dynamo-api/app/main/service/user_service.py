...
def save_new_user(data):
    ...
    existing_user = document.get_item(Key={'email': data['email']})
    if existing_user:
        return {
            'status': 'fail',
    ...
    document.put_item(Item=user_item)
...
def get_user_by_email(email):
    ...
    user = document.query(IndexName='email', KeyConditionExpression='email = :email',
