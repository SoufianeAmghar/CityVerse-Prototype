...
function App(props) {
  ...
  return (
    <ThemeConfig>
      <BrowserRouter>
      <Suspense fallback={<div style={{display:'flex',flexDirection:"column",alignItems:"center",justifyContent:'center',height:"100vh",width:"100%"}}>
                <CircularProgress
                  color="success"
                  disableShrink
                  sx={{
